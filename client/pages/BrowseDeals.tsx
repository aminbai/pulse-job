  ...
  const deals = [
    {
      ...
      views: 144,
      image: "https://cdn.builder.io/api/v1/image/assets%2F0d81b279190c4b9c90453e4f7403e39c%2Ff8ea0ba9cfcb4b7aa06255fd787fa9f9?format=webp&width=800",
          ...
          <div>
                ...
                <Card key={deal.id} className="overflow-hidden hover:shadow-lg transition-shadow cursor-pointer">
                  ...
                  <CardContent className="p-4">
                    ...
                    <div className="flex justify-between items-center">
                      <span className="text-lg font-bold text-brand-green">{deal.price}</span>
                    </div>
                  </CardContent>
                </Card>
              ))}
            ...
            {deals.length === 1 && (
              <div className="text-center py-12">
                <p className="text-gray-500">More deals will appear here as they become available.</p>
              </div>
            )}
          </div>
        </div>
