  ...
  const articles = [
    {
      ...
      description: "Learn how to efficiently manage your finances on our platform with step-by-step guides for deposits and withdrawals."
    },
    {
      id: 2,
      title: "Seamless Sign-Up and Login: A Guide to Getting Started on GigClickers.com",
      category: "Sign up and login",
      date: "Feb 18, 2024",
      image: "/placeholder.svg",
      description: "Complete guide to creating your account and accessing all the features GigClickers has to offer."
    },
    {
      id: 3,
      ...
      date: "Feb 18, 2024", 
      image: "/placeholder.svg",
      description: "Discover how to earn more by referring friends and building your network on GigClickers."
    },
    {
      id: 4,
      ...
      date: "Feb 18, 2024",
      image: "/placeholder.svg",
      description: "Master the art of creating compelling job posts that attract the best freelancers."
    },
    {
      id: 5,
      ...
      date: "Feb 18, 2024",
      image: "/placeholder.svg",
      description: "Tips and strategies for freelancers to find and secure their ideal projects."
    },
    {
      id: 6,
      ...
      date: "Mar 04, 2025",
      image: "/placeholder.svg",
      description: "Explore our partner platform and discover new opportunities in the microjob marketplace."
    },
    {
      id: 7,
      title: "TaskBurg.com: A Reliable Microjob Platform for Earning and Hiring",
      category: "partner website",
      date: "Mar 15, 2025",
      image: "/placeholder.svg",
      description: "Learn about TaskBurg's features and how it complements the GigClickers ecosystem."
    },
    {
      id: 8,
      ...
      date: "Mar 15, 2025",
      image: "/placeholder.svg",
      description: "The future of freelancing and microjobs in the digital economy."
    },
    {
      id: 9,
      ...
      date: "Mar 15, 2025",
      image: "/placeholder.svg",
      description: "Step-by-step guide to withdrawing your earnings from Taskburg platform."
    },
    {
      id: 10,
      title: "Taskburg.com",
      ...
      date: "Mar 15, 2025",
      image: "/placeholder.svg",
      description: "Everything you need to know about our partner platform Taskburg.com"
    }
  ];
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-6xl mx-auto px-6 py-8">
        <div className="space-y-8">
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex space-x-4 text-sm text-gray-600">
              {categories.map((category, index) => (
                <a key={index} href={`#${category.replace(/\s+/g, '-').toLowerCase()}`} className="hover:text-brand-green">
                  {category}
                </a>
              ))}
            </div>
          ...
          <div>
            <h2 className="text-2xl font-bold text-gray-800 mb-6">Latest Article</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
              ...
              <div className="space-y-2">
                {categories.slice(0, 5).map((category, index) => (
                  <div key={index} className="flex justify-between items-center py-2 border-b border-gray-200">
                    ...
                    <span className="text-sm text-gray-500">{Math.floor(Math.random() * 20) + 5} articles</span>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div>
              ...
              <div className="space-y-3">
                <a href="/help" className="block text-brand-green hover:underline">Help Center</a>
                <a href="/tutorials" className="block text-brand-green hover:underline">Video Tutorials</a>
                <a href="/faq" className="block text-brand-green hover:underline">Frequently Asked Questions</a>
                <a href="/contact" className="block text-brand-green hover:underline">Contact Support</a>
                <a href="/community" className="block text-brand-green hover:underline">Community Forum</a>
              </div>
            </div>
          </div>
        </div>
