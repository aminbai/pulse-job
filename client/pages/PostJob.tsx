...
export default function PostJob() {
  ...
  const [selectedCategory, setSelectedCategory] =
    useState<string>("gmail-account");
  const [selectedSubcategory, setSelectedSubcategory] =
    useState<string>("New Gmail Account");
  ...
  const [workerEarn, setWorkerEarn] = useState<number>(1.0);
              ...
              <div className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    value={workerNeed}
                    onChange={(e) =>
                      setWorkerNeed(parseInt(e.target.value) || 1)
                    }
                ...
                <div>
                  ...
                  <input
                    ...
                    value={workerEarn}
                    onChange={(e) =>
                      setWorkerEarn(parseFloat(e.target.value) || 0)
                    }
                    className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-brand-green focus:border-transparent text-lg"
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <p className="font-semibold">
                    {selectedZone
                      ? targetingZones.find((z) => z.id === selectedZone)?.label
                      : "-"}
                  </p>
                </div>
                      ...
                      <div>
                        ...
                        {selectedCountries.length > 10 && (
                          <span className="block mt-1">
                            ... and {selectedCountries.length - 10} more
                          </span>
                        )}
                      </div>
                    ) : (
