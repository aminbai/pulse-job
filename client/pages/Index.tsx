...
const categories = [
  { name: "Web Development", jobs: 1250, icon: Code, color: "from-blue-500 to-blue-600", bgColor: "bg-blue-50", textColor: "text-blue-600" },
  { name: "Graphic Design", jobs: 890, icon: Palette, color: "from-purple-500 to-purple-600", bgColor: "bg-purple-50", textColor: "text-purple-600" },
  { name: "Mobile Apps", jobs: 650, icon: Smartphone, color: "from-green-500 to-green-600", bgColor: "bg-green-50", textColor: "text-green-600" },
  { name: "Digital Marketing", jobs: 1200, icon: Megaphone, color: "from-orange-500 to-orange-600", bgColor: "bg-orange-50", textColor: "text-orange-600" },
  { name: "Writing & Content", jobs: 950, icon: FileText, color: "from-red-500 to-red-600", bgColor: "bg-red-50", textColor: "text-red-600" },
  { name: "Video & Animation", jobs: 450, icon: Briefcase, color: "from-indigo-500 to-indigo-600", bgColor: "bg-indigo-50", textColor: "text-indigo-600" },
];
...
const faqs = [
  {
    ...
    answer: "Simply sign up for free, create your professional profile, showcase your portfolio, and start bidding on projects that match your expertise. Our AI matching system will also recommend relevant opportunities."
  },
  {
    question: "How does the payment system work?",
    answer: "We use a secure escrow system. Funds are deposited by clients and held safely until project milestones are completed to satisfaction. Payments are processed within 24 hours of approval."
  },
  {
    question: "What types of projects are available?",
    answer: "We have thousands of projects across 100+ categories including web development, design, writing, marketing, data science, mobile apps, and much more. From small tasks to large enterprise projects."
  },
  {
    question: "How do I ensure quality work?",
    answer: "All freelancers go through a verification process. We have a comprehensive rating system, work samples, client reviews, and a satisfaction guarantee. Plus 24/7 support to resolve any issues."
  },
  {
    question: "Are there any fees?",
    answer: "It's free to join and browse projects. We charge a small service fee only when you successfully complete projects. Transparent pricing with no hidden costs."
  },
];
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-gradient-to-br opacity-0 group-hover:opacity-10 transition-opacity duration-300"
           style={{ backgroundImage: `linear-gradient(to bottom right, ${category.color.split(' ')[1]}, ${category.color.split(' ')[3]})` }}></div>
      <div className="relative z-10">
        ...
        <div className="flex items-center text-brand-green text-sm font-medium">
          Browse Jobs <ArrowRight className="w-4 h-4 ml-1 group-hover:translate-x-1 transition-transform" />
        </div>
      </div>
    </Link>
  );
...
const FeatureCard = memo(({ feature, index, variant = 'light' }: { feature: any, index: number, variant?: 'light' | 'dark' }) => {
  ...
  return (
    <div 
      className={`group text-center p-6 rounded-xl transition-all duration-300 hover:scale-105 ${
        isDark ? 'bg-white bg-opacity-10 backdrop-blur-sm' : 'bg-white shadow-lg hover:shadow-xl'
      }`}
      style={{
    ...
    >
      <div className={`relative w-16 h-16 mx-auto mb-4 ${
        ...
        <IconComponent className={`w-8 h-8 ${isDark ? 'text-white' : feature.color}`} />
        {feature.stat && (
      ...
      <p className={`text-sm leading-relaxed ${isDark ? 'text-green-100' : 'text-gray-600'}`}>
        {feature.description}
      </p>
    </div>
  );
...
const FAQItem = memo(({ faq, index, isOpen, onToggle }: { faq: any, index: number, isOpen: boolean, onToggle: () => void }) => (
  <div className="mb-4 group">
    ...
    >
      ...
      <div className={`flex-shrink-0 w-8 h-8 rounded-full bg-brand-green-light flex items-center justify-center transition-transform duration-300 ${isOpen ? 'rotate-180' : ''}`}>
        {isOpen ? (
...
export default function Index() {
  ...
  const toggleFaq = useMemo(() => (index: number) => {
    ...
    <div className="min-h-screen bg-white overflow-x-hidden">
      ...
      <section className="relative bg-gradient-to-br from-brand-green-light via-green-50 to-blue-50 py-12 sm:py-16 lg:py-24 overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute top-1/2 -left-8 w-64 h-64 bg-blue-500 opacity-10 rounded-full blur-3xl" style={{animationDelay: '1s'}}></div>
        </div>

        <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            <div className={`space-y-6 lg:space-y-8 ${isLoaded ? 'animate-slideInFromLeft' : 'opacity-0'}`}>
              <div className="space-y-4">
                ...
                <p className="text-lg lg:text-xl text-gray-600 leading-relaxed max-w-xl">
                  ...
                  Whether you're hiring or seeking work, we make success simple.
                </p>
              </div>
            ...
            <div className="relative flex justify-center lg:justify-end">
              <div className="relative w-80 h-80 lg:w-96 lg:h-96">
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-blue-500 to-blue-600 rounded-3xl transform -rotate-6 shadow-2xl opacity-80" style={{animationDelay: '1s'}}></div>
                <div className="relative z-10 w-full h-full bg-white rounded-3xl shadow-2xl flex items-center justify-center">
                  <div className="text-center">
                    ...
                    <div className="text-2xl font-bold text-gray-900 mb-2">Find Your</div>
                    <div className="text-2xl font-bold text-brand-green">Perfect Match</div>
                  </div>
                </div>
                
                {/* Floating elements */}
                <div className="absolute -top-4 -right-4 w-16 h-16 bg-yellow-400 rounded-xl flex items-center justify-center shadow-lg animate-float" style={{animationDelay: '2s'}}>
                  <Star className="w-8 h-8 text-white" />
                </div>
                <div className="absolute -bottom-4 -left-4 w-16 h-16 bg-purple-500 rounded-xl flex items-center justify-center shadow-lg animate-float" style={{animationDelay: '3s'}}>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 lg:mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Discover thousands of opportunities across diverse skill sets and industries
            </p>
          </div>
      ...
      <section className="py-16 lg:py-24 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 lg:mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Access global talent, manage projects effortlessly, and scale your business with confidence
            </p>
          </div>
        ...
        <div className="relative container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 lg:mb-16">
            ...
            <p className="text-lg text-green-100 max-w-2xl mx-auto">
              Find high-quality projects, build your reputation, and grow your freelance career
            </p>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            {memoizedWorkerFeatures.map((feature, index) => (
              <FeatureCard key={feature.title} feature={feature} index={index} variant="dark" />
            ))}
          </div>
            ...
            <div className="bg-gradient-to-r from-brand-green-light to-blue-50 rounded-2xl p-8 lg:p-12">
              <div className="text-center">
                ...
                <blockquote className="text-xl lg:text-2xl font-medium text-gray-900 mb-6">
                  "ClickerPlus transformed my freelance career. The quality of projects and clients is outstanding, and the payment system is incredibly reliable."
                </blockquote>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="lg:col-span-1">
              ...
              <p className="text-gray-300 mb-6 leading-relaxed">
                Connecting talent with opportunity worldwide. Build your career or grow your business with us.
              </p>
              <div className="flex space-x-4">
                <a href="#" className="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-brand-green transition-colors">
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li><Link to="/post-job" className="text-gray-300 hover:text-white transition-colors">Post Job</Link></li>
          ...
          <div className="border-t border-gray-800 pt-8 mt-12">
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex items-center space-x-4 mt-4 md:mt-0">
                <span className="text-gray-400 text-sm">Made with ❤️ for freelancers worldwide</span>
              </div>
            </div>
          </div>
        </div>
